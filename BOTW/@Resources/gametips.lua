...
tip_text = {
  ...
  "Monsters have a harder time detecting you if your press LSTICK to crouch and quietly approach them.",
  ...
  "Horses you have registered are displayed on the map. If one of them is nearby, call it with DPAD-DOWN and it will come running.",
  ...
  "Use L and X to kick off from the surface you're currently climbing. If you use the paraglider right afterward to gllide, you can reach many new places.",
  "Overhangs that curve outward and the underside of ceilings are too difficult to hang on to. If you triy to climbd these surfaces anyway, you will fall.",
  "In rainy weather, cliffs become slippery and may not be possible to scale. Wait for clear weather before attemplting to climb a steep cliff whenever possible.",
  "When you're in a hurry to climb somewhere, you can scale a wall quicker by using X. Doing so uses up a lot of stamina, so make sure you have enough left to make it to the top!",
  ...
  "An ice pillar can be broken by lining your reticle up with it and pressing A.",
  "Aim at your feet with DPAD-DOWN to create an ice pillar directly beneath you. Press DPAD-DOWN again to return to the reticle.",
  "Wildlife taking shelter in the grass will sometimes jump out when you cut down their hiding place.",
  "- While targeting an enemy, execute a backflip by holding left-trigger down and pressing X. This move is useful for dodging enemy attacks.",
  ...
  "If you get lost, try climbing to higher ground and looking around. Press R to pull out your scope so you can see even farther.",
  ...
  "As your horse's speed increases—between walk, trot, canter, and gallop—their gait changes as well. Use A to increase your speed, and use LSTICK-DOWN to decrease it.",
  "While totally motionless, if you press and hold ZL, your horse will take careful steps in any direction with LSTICK. Do this if your horse balks or when you find yourself stuck somewhere.",
  ...
  "In the extreme heat of volcanic regions, wooden bows or shields you have equiped will catch fire. It's better to use metal equipment instead.",
  ...
  "A plume of smoke in the distance if a good sign that you might find someone at its origin.",
  ...
  "Swimming depletes your stamina. If this runs out while you're swimming, you will sink below the water and, unless you've run ouf of hearts, be returned to dry land.",
  ...
  "This power allows you to halt time for certain objecsts, completely stopping them in place.",
  ...
  "Press ZL while near an enemy to target it. When locked on to something, you can freely circle around it.",
  ...
  "Obedient horses will follow pathways withoiut being told to. Leave the running up to your loyal steed every once in a while so you can enjoy the scenery!",
  "If your weapon is close to breaking, try throwing it at an enemy using ZL. It will double your damage if it hits!",
