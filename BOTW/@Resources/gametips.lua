...
tip_text = {
  ...
  "Use L and X to kick off from the surface you're currently climbing. If you use the paraglider right afterward to glide, you can reach many new places.",
  "Overhangs that curve outward and the underside of ceilings are too difficult to hang on to. If you try to climbd these surfaces anyway, you will fall.",
  ...
  "While targeting an enemy, execute a backflip by holding LSTICK-DOWN and pressing X. This move is useful for dodging enemy attacks.",
